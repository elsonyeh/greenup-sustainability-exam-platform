                    ...
                    <div className="bg-white rounded-2xl shadow-lg overflow-hidden border-2 border-gray-100">
                        ...
                        <div className="divide-y divide-gray-100">
                            {currentData.map((user, index) => (
                                <div
                                    key={`${user.rank}-${index}`}
                                    className={`px-6 py-4 transition-all duration-200 hover:bg-gray-50 ${user.isCurrentUser
                                ...
                                >
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div className="flex-shrink-0">
                                            {user.rank <= 3 ? (
                                                <div className={`w-12 h-12 rounded-full flex items-center justify-center shadow-lg ${user.rank === 1 ? 'bg-gradient-to-br from-yellow-400 to-yellow-600' :
                                                ...
                                                <div className={`w-12 h-12 rounded-full flex items-center justify-center border-2 ${user.isCurrentUser
                                        ...
                                        <div className="flex items-center flex-1 min-w-0 gap-3">
                                            ...
                                            <div className="flex-1 min-w-0">
                                                <div className="flex items-center gap-2 mb-1">
                                                    <p className={`font-bold text-base truncate ${user.isCurrentUser ? 'text-blue-700' : 'text-gray-900'
                                                        }`}>
                                                        {user.name}
                                                    </p>
                                                    {user.isCurrentUser && (
                                        ...
                                        <div className="flex-shrink-0 text-right">
                                            <p className={`text-2xl font-black ${user.isCurrentUser ? 'text-blue-600' :
